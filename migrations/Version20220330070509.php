 ...
 */
final class Version20220330070509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD token_reset VARCHAR(255) DEFAULT NULL, ADD token_reset_created_at DATETIME DEFAULT NULL');
